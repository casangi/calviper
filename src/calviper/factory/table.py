...
class GainTable(BaseJonesMatrix):
    ...
    def empty_like(dataset: xr.Dataset) -> xr.Dataset:
        ...
        xds["PARAMETER"] = xr.DataArray(gain, dims=dims)
...
class CalibrationTable(JonesFactory):
    ...
    def create_table(self, factory: str) -> Union[BaseJonesMatrix, None]:
        try:
